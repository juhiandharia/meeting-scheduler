  ...
  return (
    <div className='flex flex-col justify-center items-center my-20'>
        <div className='hidden lg:block'>
            ...
            <Image src='/clock.jpg' width={100} height={100}
            className='h-[100px] object-cover rounded-full absolute bottom-20 left-36'/>

            <Image src='/paxel.jpg' width={100} height={100}
        ...
        <div className='text-center max-w-3xl'>
            ...
            <h2 className='text-xl mt-5 text slate-500'>Scheduly is your scheduling automation platform for eliminating the back-and-forth emails to find the perfect time and so much more.
            </h2>
